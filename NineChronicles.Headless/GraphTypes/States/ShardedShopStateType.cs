...
{
    public class ShardedShopStateType : ObjectGraphType<ShardedShopState>
    {
        public ShardedShopStateType()
        {
            Field<NonNullGraphType<AddressType>>(
                nameof(ShardedShopState.address),
                description: "Address of sharded shop.",
                resolve: context => context.Source.address);
            Field<NonNullGraphType<ListGraphType<ShopItemType>>>(
                nameof(ShardedShopState.Products),
